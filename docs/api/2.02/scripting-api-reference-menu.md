---
title: "FMOD - Scripting API Reference | Menu"
source: "FMOD 2.02 Studio Scripting API"
downloaded: "2026-02-24"
---

# 26\. Scripting API Reference | Menu

## [Module: Menu](#module-menu)

The `studio.menu` module provides access to menu bar items.

### [menu.addMenuItem(description)](#menuaddmenuitemdescription)
...
### [menu.removeMenuItem(description)](#menuremovemenuitemdescription)

Removes a menu item that was added with [menu.addMenuItem()](#menuaddmenuitemdescription). The `description` argument must match a `description` that the menu item was added with.

Returns `true` if the operation succeeds, or `false` otherwise.

### [menu.menuItems()](#menumenuitems)

Returns an `Array` of menu item descriptions added with [menu.addMenuItem()](#menuaddmenuitemdescription). The order of the `Array` matches the order in which the items were added.
